...
contract token is ERC20, Ownable {
    ...
    string private constant _name = "Bondifa";
    string private constant _symbol = "BOND";
    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 215144961 * 10**uint256(_decimals);

    bool public isAntiWhale;
    uint256 public maxSell = 215144961 * 10**uint256(_decimals);
    ...
    constructor() ERC20("Bondifa", "BOND") {
    ...
    function _transfer(
        ...
        require(!blacklist[sender] && !blacklist[recipient],"You've been blacklisted");
